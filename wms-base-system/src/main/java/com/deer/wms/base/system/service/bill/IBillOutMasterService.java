...
public interface IBillOutMasterService  extends Service<BillOutMaster, Integer>
{
     ...
     * @return
     */
    public List<BillOutMasterDto> selectBillOutMasterList(BillOutMasterCriteria billOutMasterCriteria);
    ...
    List<BillOutMasterDto> findListTwo(BillOutMasterCriteria criteria);
