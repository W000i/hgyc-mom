...
public class RequestId {
     ...
     * 采购接收请求发送前
     */
    public RequestId(String requestId, Integer itemId, Integer quantity, String lotNumber, Integer poHeaderId, Integer poLineId, Integer poLineLocationId, Integer poDistributionId, String receiptDate, Integer organizationId, Integer type,Integer state,String errorMsg,String processStatus,String expirationDate,String originationDate) {
        this.requestId = requestId;
        this.itemId = itemId;
        this.quantity = quantity;
        this.lotNumber = lotNumber;
     ...
     * 采购接收请求发送后
     */
    public RequestId(String requestId, String processStatus, String lastUpdateDate, String lastUpdatedBy, String creationDate, String createdBy, Integer itemId, Integer quantity, String lotNumber, Integer poHeaderId, Integer poLineId, Integer poLineLocationId, Integer poDistributionId, String receiptDate, Integer id, Integer organizationId, Integer type,String receiptNum,String dueDate,String expirationDate,String originationDate) {
        this.requestId = requestId;
        this.processStatus = processStatus;
        this.lastUpdateDate = lastUpdateDate;
        this.lastUpdatedBy = lastUpdatedBy;
     ...
     * WMS交货前
     */
    public RequestId(String requestId, Integer quantity, String lotNumber, String transactionDate, String shipmentNum, String subInventory, Integer locatorId, Integer organizationId, Integer transactionId, Integer type,Integer state,String errorMsg,String processStatus) {
        this.requestId = requestId;
        this.quantity = quantity;
        this.lotNumber = lotNumber;
        this.transactionDate = transactionDate;
     ...
     * WMS交货后
     */
    public RequestId(String requestId, String processStatus, String lastUpdateDate, String lastUpdatedBy, String creationDate, String createdBy, Integer quantity, String lotNumber, Integer id, String transactionDate, String shipmentNum, String errorMsg, String subInventory, Integer locatorId, Integer organizationId, Integer transactionId, Integer type) {
        this.requestId = requestId;
        this.processStatus = processStatus;
        this.lastUpdateDate = lastUpdateDate;
        this.lastUpdatedBy = lastUpdatedBy;
     ...
     * 调用工单发料接口后
     */
    public RequestId(String requestId, String processStatus, String lastUpdateDate, String lastUpdatedBy, String creationDate, String createdBy, Integer itemId, Integer quantity, String lotNumber, Integer id, String transactionDate, String errorMsg, String subInventory, Integer locatorId, Integer organizationId, Integer type, String transactionTypeId, String wipEntityId, String operationSeqnum, String transactionUom) {
        this.requestId = requestId;
        this.processStatus = processStatus;
        this.lastUpdateDate = lastUpdateDate;
        this.lastUpdatedBy = lastUpdatedBy;
