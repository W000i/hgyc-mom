...
public interface IBoxItemService extends Service<BoxItem, String>
{
	 ...
	 * 查找合适的货位进行预测备料
	 */
	List<BoxItemDto> findSuitByItemCodeAndQuantity(String itemCode, Integer quantity,String workerOrderId);
	...
	List<Box> findByCellId(BoxItemCriteria criteria);

	List<InventoryCompare> selectList(BoxItemCriteria criteria);

	List<BoxItemDto> findListTwo(BoxItemCriteria criteria);
}
